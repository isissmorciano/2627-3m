from src.m05_file_json_e_package.es03_reference import carica_prodotti_csv, salva_prodotti_csv
...
def test_csv_inesistente():
    assert carica_prodotti_csv("catalogo_inesistente.csv") == []
